...
The Compound protocol provides cToken for available digital assets (Ether, USD Coin, Augur, Dai, Sai, Wrapped BTC, Ox, Basic Attention Token), this enables WeFarm to supply/withdraw assets to Compound to improve the utilization rate of WeFarm. 
